...
def get_new_calcium_dir(drug, dose, animal_id):
...
def get_new_calcium_data(drug, dose, animal_id):
    # reshape
    # ctrl: 15 min * 60 sec * 5 Hz sampling rate = 4500
    # amph: 45 min * 60 sec * 5 Hz sampling rate = 13500
    calcium_ctrl_path, calcium_amph_path = get_new_calcium_dir(drug, dose, animal_id)
