...
def event_per_speed():
    ...
    for drug in drugs:
        ...
        for experiment in experiments:
            ...
            _, _, mars_left_angle_ctrl, mars_left_angle_amph = mars_feature(drug, dose, experiment)
            ...
            for t in range(0, len(mars_left_angle_amph)):
                if mars_left_angle_amph[t] <= 30:
                    bin1_events_ctrl.append(eventmean_amph[t])
                    bin1_duration_amph += 1
                if 30 < mars_left_angle_amph[t] <= 60:
                    bin2_events_ctrl.append(eventmean_amph[t])
                    bin1_duration_amph += 1
                if 60 < mars_left_angle_amph[t] <= 90:
                    bin3_events_ctrl.append(eventmean_amph[t])
                    bin1_duration_amph += 1
